...
strictfp class BuildStrat {
    ...
    static void runBuilder(RobotController rc) throws GameActionException {
        ...
        if(rc.getTeamLeadAmount(rc.getTeam()) > 500 && turn % 30 == 0 && rc.canBuildRobot(RobotType.LABORATORY, dir)){
            rc.buildRobot(RobotType.LABORATORY, dir);
        }else if(rc.getTeamLeadAmount(rc.getTeam()) > 500 && turn % 50 == 0 && rc.canBuildRobot(RobotType.WATCHTOWER, dir)) {
